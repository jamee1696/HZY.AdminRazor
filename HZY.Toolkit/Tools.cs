...
namespace HZY.Toolkit
{
    ...
    public static class Tools
    {
        ...
        /// 写入日志对象
        /// </summary>
        public static NLogHelper Log => new NLogHelper();

        public static bool IsAjaxRequest(this HttpContext httpContext) 
            => (httpContext.Request.Headers.ContainsKey("X-Requested-With") ? httpContext.Request.Headers["X-Requested-With"] == "XMLHttpRequest" : false);
